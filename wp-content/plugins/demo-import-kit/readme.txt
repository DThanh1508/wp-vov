...
Gitlab:
Demo Import Kit require the use of 3rd party (i.e. external) Gitlab services to store demo data i.e files with extensions such as .zip, .xml, .json.
Source: https://about.gitlab.com/
GitLab Terms of Use: https://about.gitlab.com/terms/
GitLab Privacy Policy: https://about.gitlab.com/privacy/#privacy-policy

Demo Import Kit retrieves theme import data remotely from Gitlab using v4 REST API. https://gitlab.com/api/v4/projects/20724620/repository/files/
Gitlab Repository URL: https://gitlab.com/themeinwp/demo-import
